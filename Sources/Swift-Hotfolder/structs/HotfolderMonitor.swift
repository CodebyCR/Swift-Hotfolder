...
//        await HotfolderWatcher.shared.add(hotfolder: hotfolder1)
//        await HotfolderWatcher.shared.add(hotfolder: hotfolder2)
//
//        // Start watching
//        do {
//            try await HotfolderWatcher.shared.watch { change in
//                switch change {
...
//            await HotfolderWatcher.shared.add(hotfolder: hotfolder3)
